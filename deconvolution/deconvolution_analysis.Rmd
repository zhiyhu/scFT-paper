...
```{r}
df_grade <- data.frame(grade = toteset$grade,
                       exprs = toteset@assayData$exprs["CAPSL",])

ggplot(df_grade, aes(x = as.factor(grade), y = exprs)) + geom_violin()
...
```{r}
# saveRDS(eset, "rds/20191009_esetTCGA_afterDeconvolution.rds")
```
