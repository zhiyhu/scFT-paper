...
```{r dimplot-ftsc.integrated, fig.width=8, fig.height=3}
...
```{r DimPlot-umap-cancer-versus-benign, fig.height=3, fig.width=8}
...
```{r plotScoreUmap, fig.width=12, fig.height=3}
